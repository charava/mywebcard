  ...
  return (
    <div className="App">
      <div className="main-container flex-start">
        <p className="photographing2020">BTW, I also did a lil social-justice photo project in 2020 that you can check out <a href="https://photographing2020.onuniverse.com/" target="_blank" rel="noopener noreferrer">here</a>.</p>
